...
Select 
	inv_amount.invoiceid "Nummer_Gutschrift" , inv_amount.invoiceaccount, inv_amount.salesid, cast(inv_amount.invoiceamount as FLOAT) "OriginalAmount",inv_amount.paymmode,
